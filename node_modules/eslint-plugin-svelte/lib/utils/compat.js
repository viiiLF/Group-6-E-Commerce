import { getSourceCode as getSourceCodeBase, getFilename as getFilenameBase, getPhysicalFilename as getPhysicalFilenameBase, getCwd as getCwdBase } from 'eslint-compat-utils';
...
export function getSourceCode(context) {
    return getSourceCodeBase(context);
}
/**
...
export function getFilename(context) {
    return getFilenameBase(context);
}
/**
...
export function getPhysicalFilename(context) {
    return getPhysicalFilenameBase(context);
}
/**
